...
class image_converter:
    ...
    def line_detect(self, cv_image):
        ...
        if len(contours_blk) > 0 and cv2.contourArea(contours_blk[0]) > 200:
            ...
            error_corr = (self.Kp * normal_error + self.Ki * self.integral + self.kd * self.derivative)  # PID controler
    ...
    def callback(self, data):
        ...
        # height, width, _ = cv_image.shape eka
        # print(width, 'x', height) eka
