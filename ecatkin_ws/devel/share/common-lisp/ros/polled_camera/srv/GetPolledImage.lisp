...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetPolledImage-response>)))
  ...
  (cl:format cl:nil "bool success          # Could the image be captured?~%string status_message # Error message in case of failure~%time stamp            # Timestamp of the captured image. Can be matched~%                      # against incoming sensor_msgs/Image header.~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetPolledImage-response)))
  "Returns full string definition for message of type 'GetPolledImage-response"
  (cl:format cl:nil "bool success          # Could the image be captured?~%string status_message # Error message in case of failure~%time stamp            # Timestamp of the captured image. Can be matched~%                      # against incoming sensor_msgs/Image header.~%~%~%~%"))
