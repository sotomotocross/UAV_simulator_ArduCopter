...
echo_and_run cd "/home/sotiris/ROS_workspaces/ecatkin_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/home/sotiris/ROS_workspaces/ecatkin_ws/src/vision_opencv/image_geometry/setup.py" \
     \
    build --build-base "/home/sotiris/ROS_workspaces/ecatkin_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
