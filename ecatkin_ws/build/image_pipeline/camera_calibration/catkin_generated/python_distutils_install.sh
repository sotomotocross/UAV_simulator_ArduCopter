...
echo_and_run cd "/home/sotiris/ROS_workspaces/ecatkin_ws/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/home/sotiris/ROS_workspaces/ecatkin_ws/src/image_pipeline/camera_calibration/setup.py" \
     \
    build --build-base "/home/sotiris/ROS_workspaces/ecatkin_ws/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
