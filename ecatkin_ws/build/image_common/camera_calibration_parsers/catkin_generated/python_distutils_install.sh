...
echo_and_run cd "/home/sotiris/ROS_workspaces/ecatkin_ws/src/image_common/camera_calibration_parsers"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/sotiris/ROS_workspaces/ecatkin_ws/build/image_common/camera_calibration_parsers \
    build --build-base "/home/sotiris/ROS_workspaces/ecatkin_ws/build/image_common/camera_calibration_parsers" \
    install \
    --root="${DESTDIR-/}" \
